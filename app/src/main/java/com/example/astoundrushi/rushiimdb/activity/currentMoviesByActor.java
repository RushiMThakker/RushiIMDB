 ...
 */
public class CurrentMoviesByActor extends AsyncTask<ArrayList<CinemalyticsMoviesByActor>,Void,Void>
{
    @Override
    protected Void doInBackground(ArrayList<CinemalyticsMoviesByActor>... params)
    {
        ArrayList<CinemalyticsMoviesByActor> currentMoviesByActor=new ArrayList<>();
        return null;
    }
