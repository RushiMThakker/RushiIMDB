...
/**
 * Created by Astound Rushi on 9/6/2016.
 */
public class YoutubeSearch extends AsyncTask<ArrayList<String>, Integer, Integer>
{
     ...
     */
    public void startSearch(ArrayList<String> querySongs)
    {
/*        // Read the developer key from the properties file.
        ...
        try
        {
            ...
            for (int i = 0; i < querySongs.size(); ++i)
            {
                ...
                {
                    prettyPrint(searchResultList.iterator(), querySongs.get(i));
                }
            }
    ...
    private void prettyPrint(Iterator<SearchResult> iteratorSearchResults, String query)
    {
        ...
        while (iteratorSearchResults.hasNext())
        {
            ...
            if (rId.getKind().equals("youtube#video"))
            {
                ...
                Log.d("<<<<YOUTUBE RESULTS>>>>","");
                Log.d("<<<<YOUTUBE RESULTS>>>>"," Video Id" + rId.getVideoId());
                Log.d("<<<<YOUTUBE RESULTS>>>>"," Title: " + singleVideo.getSnippet().getTitle());
                Log.d("<<<<YOUTUBE RESULTS>>>>"," Thumbnail: " + thumbnail.getUrl());
                Log.d("<<<<YOUTUBE RESULTS>>>>","\n-------------------------------------------------------------\n");
