 ...
 */
public class MostPopularMoviesByActor extends AsyncTask<ArrayList<CinemalyticsMoviesByActor>,Void,Void>
{
    @Override
    protected Void doInBackground(ArrayList<CinemalyticsMoviesByActor>... params)
    {
        ArrayList<CinemalyticsMoviesByActor> mostPopularMoviesByActor=new ArrayList<>();
        return null;
    }
